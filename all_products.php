...
<head>
  ...
  <style>
    ...
    .featured-area.portfolio .filters-group::-webkit-scrollbar {
      display: none;
    }
    ...
    .featured-area.portfolio .tab_content {
    ...
    .featured-area.portfolio .featured-item:hover .featured-item-img::after {
      opacity: 1;
    }
                  ...
                  <div class="row justify-content-center">
                    <?php
                                ...
                                if($no_of_rows == 0){
                                        ?>
                    <center>
                      <p class="" style="font-size:3.2rem;margin-bottom:6.2rem;"><b>No Products Available</b></p>
                    </center>
                    <?php        
                                    }
                                    else{
                      ...
                      <div class="featured-item">
                        ...
                        <div class="content">
                          ...
                          <?php
                                       ...
                                       ?>
                          <form onsubmit="return cart(this);" id="myform" method="post" enctype="multipart/form-data"
                            class="cart">
                            <!--<p class="qty">-->
                            ...
                            <div class="content-in">
                              <h4 style="text-decoration: line-through;">Rs.
                                <?php echo$old_price;?>
                              </h4>
                              <h4>Rs.
                                <?php echo $new_price;?>
