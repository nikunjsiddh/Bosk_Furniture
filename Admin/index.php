...
<body class="homepage-1 int_white_bg">
   ...
   <div class="card">
   <form method="post" id="myform" class="mt-5" action="https://demos.pixinvent.com/stack-html-admin-template/html/ltr/vertical-modern-menu-template/Dashboard.php" >
      ...
      <button type="submit" name="signin" id="signin" class="cta-btn">Log In</button>
