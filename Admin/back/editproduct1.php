<?php
  include("../connect.php");
	    ...
	    if(isset($_POST['id']))
	    {
            ...
            // $cmd="UPDATE `products` SET `pname`='$pname' WHERE id='$id'";
            $cmd="UPDATE `products` SET `pname`='$pname',`pcategory`=' $pcategory',`description`='$description',`publish_date`='$datetime',`sku`='$sku',`stock`='$stock',`status`='$status',`old_price`='$old_price',`new_price`='$new_price',`mrp`='$new_price',`tags`='$tags' WHERE id='$id'";
