       ...
       <?php include_once"design/sidebar.php"?> 
        ...
        <div class="main px-lg-4 px-md-4"> 
           ...
           <?php include_once"design/nav.php"?>
            ...
            <!-- Body: Body -->
             <form onsubmit="return blog(this);" id="myform" method="post" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="row g-3 align-items-center">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <textarea type="text" name="blog_description" class="form-control" required></textarea>
                                            </div>
                                           
                                           
                                        </div>
                                        <div class="card-header py-3 bg-transparent border-bottom-0">
                                        <h6 class="m-0 fw-bold">Blog Image Upload</h6>
