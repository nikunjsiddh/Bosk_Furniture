    ...
    <div id="wrapper">
        ...
        <section id="contact" class="contact">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-8">
                        <form  class="contact-form" onsubmit="return contact_us(this);" id="MyForm" method="post"  novalidate>
                    ...
                    <div class="col-md-4 info-touch">
                        ...
                        <div class="my-info">
                            <div class="in1">
                                <div class="address">
                                    <p style="line-height:1.3rem;"><i class="fa fa-map-marker" aria-hidden="true"></i>5,Aryamaan Complex,</p><p style="line-height:1.3rem;margin-top:-3.2rem;margin-left:4.0rem;"><br/>Near Meghani Circle,<br/>Sir Patanni Road,<br/>Bhavnagar-364001,<br/>Gujarat,India.</p>
                                </div>
                                <div class="email">
        ...
        <div class="container-fluid">
           <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3705.3028986343984!2d72.1515687748684!3d21.76853506196049!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395f5a632fce3c6b%3A0xb282e0e99abdf9db!2sBosk%20Furniture!5e0!3m2!1sen!2sin!4v1699514789660!5m2!1sen!2sin" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
