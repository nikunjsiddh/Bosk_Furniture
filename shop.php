...
/* End Sass Config */
 ...
 .qty .button1.qtyplus {
   ...
   /* ============ FILTER PILLS — single-row, defeats inline styles ============ */
   ...
   .featured-area.portfolio .filters-group::-webkit-scrollbar { display: none; }
   ...
   /* ============ PRODUCT CARD REDESIGN (matches all_products.php) ============ */
                     ...
                     <div class="tabs_item current">
                        <div class="row justify-content-center">
                            <?php
                                ...
                                $cmd3="SELECT * FROM products WHERE pcategory='$decodedcategoryname' AND (available_for_sale = 1 OR available_for_sale IS NULL) AND (status = 1 OR status IS NULL OR status = '1' OR status = 'active') AND (publish_date IS NULL OR publish_date <= NOW()) ORDER BY id DESC";
