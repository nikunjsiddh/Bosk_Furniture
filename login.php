...
<body class="homepage-1 int_white_bg">
	...
	<div class="container">
		<section class="wrapper">
			<div class="heading">
				<h1 class="text text-large">User Login</h1>
				<p class="text text-normal">New user? <span><a href="register.php" class="text text-links">Create an account</a></span>
				</p>
			</div>
			<form method="post" id="myform" action="https://demos.pixinvent.com/stack-html-admin-template/html/ltr/vertical-modern-menu-template/Dashboard.php" >
      <p><b>Your Design Journey Starts Here: Sign In for Limitless Inspiration!</b></p>
      ...
      <div class="email-login">
         ...
         <input type="text" class="form-control" placeholder="Enter Password" name="pwd" id="pwd" required>
      </div>
      <button type="submit" name="signin" id="signin" class="cta-btn btn btn-primary mt-2">Sign In</button>
        ...
        <script src="js/add/login.js"></script>
