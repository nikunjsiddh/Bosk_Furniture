        ...
        <footer class="first-footer">
                    ...
                    <div class="row">
                                ...
                                <ul>
                                    <li>
                                        <div class="info">
                                            ...
                                            <p class="in-p">5,Aryamaan Complex,<br/>Near Meghani Circle,<br/>Sir Patanni Road,<br/>Bhavnagar-364001,<br/>Gujarat,India.</p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="info">
                                ...
                                <div class="twitter-widget contuct">
                                     <div class="twitter-area">
                                        ...
                                        <div class="single-item">
                                            ...
                                            <div class="text">
                                                <h5 style="color:black !important;"><a style="color:black !important;" href="shop.php?astringdata2=<?php echo $row['name'];?>"><?php echo $name;?></a> </h5>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="newsletters">
                                <h3>Newsletters</h3>
                                <p style="color:black !important;">Sign Up for Our Newsletter to get Latest Updates and Offers. Subscribe to receive news in your inbox.</p>
                            </div>
                            <form onsubmit="return newsletter(this);" id="newsletter" class="bloq-email mailchimp form-inline" method="post">
            ...
            <div class="second-footer">
                <div class="container">
                    ...
                    <p style="color:black">Powered By <a style="color:black" href="https://softwingz.com/">SOFTWINGZ INFOTECH</a></p>
                </div>
            </div>
        </footer>
