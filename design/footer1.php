...
<footer class="first-footer">
            ...
            <div class="row">
                        ...
                        <ul>
                            <li>
                                <div class="info">
                                    ...
                                    <p class="in-p"><a href="https://share.google/J6L4mvZMeQLmtCWOF" target="_blank" rel="noopener" title="View our location on Google Maps" style="color:inherit;text-decoration:none;">5,Aryamaan Complex,<br />Near Meghani Circle,<br />Sir Patanni
                                        Road,<br />Bhavnagar-364001,<br />Gujarat,India.</a></p>
                                </div>
                            </li>
                            <li>
                                <div class="info">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="newsletters">
                        <h3>Newsletters</h3>
                        <p style="color:black !important;">Sign Up for Our Newsletter to get Latest Updates and Offers.
                            Subscribe to receive news in your inbox.</p>
                    </div>
    ...
    <div class="second-footer">
        <div class="container">
            ...
            <p style="color:black">Powered By <a style="color:black" href="https://two12.in/" target="_blank"
                    rel="noopener">Two12 Design Studio</a></p>
        </div>
    </div>
</footer>
