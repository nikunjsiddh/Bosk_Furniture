...
<style>
    ...
    .bf-orb-1 {
        ...
        top: -120px;
        left: -120px;
        animation: bf-float 14s ease-in-out infinite;
    }
    ...
    .bf-orb-2 {
        ...
        right: -100px;
        opacity: .14;
        animation: bf-float 18s ease-in-out infinite reverse;
    }
    ...
    .bf-newsletter-form input[type="email"]::placeholder {
    ...
    .bf-newsletter-wrap label.error::before {
        content: "⚠  ";
    }
    ...
    .bf-newsletter-wrap .subscription-success::before {
        content: "✓  ";
        font-weight: 700;
    }
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-12 bf-cta-text">
                    ...
                    <p class="bf-cta-sub">Subscribe for fresh designs, seasonal offers and interior inspiration —
                        straight to your inbox.</p>
                </div>
                <div class="col-lg-6 col-md-12">
                    <div class="bf-newsletter-wrap">
                        <form onsubmit="return newsletter(this);" id="newsletter" class="bf-newsletter-form mailchimp"
                            method="post" novalidate>
                            <input type="email" name="newsemail" id="newsemail" placeholder="Enter your email address"
                                autocomplete="email" maxlength="80" aria-describedby="newsletter-error">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 bf-col bf-brand-block">
                    ...
                    <ul class="bf-contact">
                        <li>
                            ...
                            <a href="https://share.google/J6L4mvZMeQLmtCWOF" target="_blank" rel="noopener" title="View our location on Google Maps" style="color:inherit;text-decoration:none;"><span>5, Aryamaan Complex, Near Meghani Circle, Sir Patanni Road, Bhavnagar-364001, Gujarat,
                                India.</span></a>
                        </li>
                        <li>
                    ...
                    <div class="bf-social-block">
                        ...
                        <div class="bf-social" aria-label="Follow us">
                            <a href="https://www.facebook.com/" target="_blank" rel="noopener" aria-label="Facebook"><i
                            ...
                            <a href="https://www.youtube.com/" target="_blank" rel="noopener" aria-label="YouTube"><i
                                    class="fa fa-youtube-play" aria-hidden="true"></i></a>
                            <a href="https://www.linkedin.com/" target="_blank" rel="noopener" aria-label="LinkedIn"><i
