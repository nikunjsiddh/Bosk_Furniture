                    ...
                    <div class="row">
                                ...
                                <div class="twitter-widget contuct">
                                    <div class="twitter-area">
                                        ...
                                        <div class="single-item">
                                            ...
                                            <div class="text">
                                                <b><h5><a href="shop.php?astringdata2=<?php echo $row['name'];?>"><?php echo $name;?></a> </h5></b>
                        ...
                        <div class="col-lg-3 col-md-6">
                            ...
                            <form onsubmit="return newsletter(this);" id="newsletter" class="bloq-email mailchimp form-inline" method="post">
                                ...
                                <div class="email">
                                    <input style="background-color:#000 !important;color:white !important;" type="email" name="newsemail" id="newsemail" placeholder="Enter Your Email">
